...
public class MouseMovePoint extends JPanel implements MouseListener, MouseMotionListener {
...
//		}
	...
	public static void main(String[] args) {
		...
		MouseMovePoint mouseMove = new MouseMovePoint();
		frame.add(mouseMove);
		frame.pack();
