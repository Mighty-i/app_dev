...
public class MouseNearPoint extends JPanel implements MouseListener, MouseMotionListener {
...
//		}
	...
	public static void main(String[] args) {
		...
		MouseNearPoint mouseMove = new MouseNearPoint();
		frame.add(mouseMove);
		frame.pack();
